...
const CATEGORIES = [
  { label: 'Home services', tag: 'Plumbing · Painting · Cleaning' },
  { label: 'Transport & delivery', tag: 'Drivers · Riders · Movers' },
  { label: 'Hospitality & care', tag: 'Catering · Hair · Beauty' },
];
    ...
    <section className="container mt-section-lg" style={{ marginTop: 80 }}>
      <div className="grid-intro">
        <div className="col" style={{ gap: 16 }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.6, color: 'var(--zinc-700)', margin: 0, maxWidth: 280 }}>
            Mikanya Logistics — your managed marketplace for trusted everyday services.
          </p>
        </div>
        <div>
          ...
          >
            {CATEGORIES.map((c) => (
              ...
              >
                ...
                >
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 22, letterSpacing: '-0.02em' }}>{c.label}</div>
                    <div style={{ fontSize: 13, opacity: 0.85, marginTop: 4 }}>{c.tag}</div>
                  </div>
                  <div
                    style={{
                      width: 44,
